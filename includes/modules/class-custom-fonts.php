...
class Gambit_Pro_Custom_Fonts {
	...
	static function setup() {
		...
		add_filter( 'gambit_pro_custom_css_stylesheet', array( __CLASS__, 'get_custom_fonts_css' ) );

		// Load Custom Fonts with the built-in theme functions.
		add_filter( 'gambit_get_fonts_url', array( __CLASS__, 'get_custom_fonts_url' ) );
	...
	static function font_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'gambit_pro_section_typography', array(
			'title'    => __( 'Typography', 'gambit-pro' ),
			'priority' => 70,
		...
		$wp_customize->add_control( new Gambit_Pro_Customize_Font_Control(
			$wp_customize, 'text_font', array(
				'label'    => esc_html__( 'Body Font', 'gambit-pro' ),
				'section'  => 'gambit_pro_section_typography',
		...
		$wp_customize->add_control( new Gambit_Pro_Customize_Font_Control(
			$wp_customize, 'title_font', array(
				'label'    => esc_html_x( 'Headings', 'Font Setting', 'gambit-pro' ),
				'section'  => 'gambit_pro_section_typography',
		...
		$wp_customize->add_setting( 'gambit_theme_options[title_is_bold]', array(
		...
		$wp_customize->add_control( 'gambit_theme_options[title_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'gambit-pro' ),
			'section'  => 'gambit_pro_section_typography',
			'settings' => 'gambit_theme_options[title_is_bold]',
			'type'     => 'checkbox',
			'priority' => 30,
		) );

		// Add Title Uppercase setting.
		$wp_customize->add_setting( 'gambit_theme_options[title_is_uppercase]', array(
		...
		$wp_customize->add_control( 'gambit_theme_options[title_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'gambit-pro' ),
			'section'  => 'gambit_pro_section_typography',
			'settings' => 'gambit_theme_options[title_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 40,
		) );
		...
		$wp_customize->add_control( new Gambit_Pro_Customize_Font_Control(
			$wp_customize, 'navi_font', array(
				'label'    => esc_html_x( 'Navigation', 'Font Setting', 'gambit-pro' ),
				'section'  => 'gambit_pro_section_typography',
		...
		$wp_customize->add_setting( 'gambit_theme_options[navi_is_bold]', array(
		...
		$wp_customize->add_control( 'gambit_theme_options[navi_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'gambit-pro' ),
			'section'  => 'gambit_pro_section_typography',
			'settings' => 'gambit_theme_options[navi_is_bold]',
			'type'     => 'checkbox',
			'priority' => 60,
		) );

		// Add Navi Uppercase setting.
		$wp_customize->add_setting( 'gambit_theme_options[navi_is_uppercase]', array(
		...
		$wp_customize->add_control( 'gambit_theme_options[navi_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'gambit-pro' ),
			'section'  => 'gambit_pro_section_typography',
			'settings' => 'gambit_theme_options[navi_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 70,
		) );
		...
		$wp_customize->add_control( new Gambit_Pro_Customize_Font_Control(
			$wp_customize, 'widget_title_font', array(
				'label'    => esc_html_x( 'Widget Titles', 'Font Setting', 'gambit-pro' ),
				'section'  => 'gambit_pro_section_typography',
		...
		$wp_customize->add_setting( 'gambit_theme_options[widget_title_is_bold]', array(
		...
		$wp_customize->add_control( 'gambit_theme_options[widget_title_is_bold]', array(
			'label'    => esc_html_x( 'Bold', 'Font Setting', 'gambit-pro' ),
			'section'  => 'gambit_pro_section_typography',
			'settings' => 'gambit_theme_options[widget_title_is_bold]',
			'type'     => 'checkbox',
			'priority' => 90,
		) );

		// Add Widget Title Uppercase setting.
		$wp_customize->add_setting( 'gambit_theme_options[widget_title_is_uppercase]', array(
		...
		$wp_customize->add_control( 'gambit_theme_options[widget_title_is_uppercase]', array(
			'label'    => esc_html_x( 'Uppercase', 'Font Setting', 'gambit-pro' ),
			'section'  => 'gambit_pro_section_typography',
			'settings' => 'gambit_theme_options[widget_title_is_uppercase]',
			'type'     => 'checkbox',
			'priority' => 100,
		) );
	}

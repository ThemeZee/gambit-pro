...
if ( ! class_exists( 'Gambit_Pro_Admin_Notices' ) ) :
...
class Gambit_Pro_Admin_Notices {
	...
	*/
	...
	static function activate_license() { 
		...
		if( '' == $options->get( 'license_key' ) && in_array( $pagenow, array( 'index.php', 'update-core.php', 'plugins.php' ) ) && current_theme_supports( 'gambit-pro' ) && ! get_transient( 'gambit_pro_activate_license_dismissed' ) && current_user_can( 'edit_theme_options' ) ) : ?>
	...
	static function expired_license() { 
		...
		if( 'expired' == $options->get( 'license_status' ) && in_array( $pagenow, array( 'index.php', 'update-core.php', 'plugins.php' ) ) && current_theme_supports( 'gambit-pro' ) && ! get_transient( 'gambit_pro_expired_license_dismissed' ) && current_user_can( 'edit_theme_options' ) ) : ?>
	...
	static function missing_theme() { 
		...
		if( ! current_theme_supports( 'gambit-pro' ) && in_array( $pagenow, array( 'index.php', 'update-core.php', 'plugins.php' ) ) && ! get_transient( 'gambit_pro_missing_theme_dismissed' ) && current_user_can( 'edit_theme_options' ) ) : ?>

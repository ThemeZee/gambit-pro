 ...
 */
class Gambit_Pro_Magazine_Posts_Single_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'gambit-magazine-posts-single', // ID.
			esc_html__( 'Magazine (Single Post)', 'gambit-pro' ), // Name.
			array(
				'classname' => 'gambit-magazine-single-widget',
				'description' => esc_html__( 'Displays a single post from a selected category.', 'gambit-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Single Post)', 'gambit-pro' ),
			'category' => 0,
		);
	...
	function render( $settings ) {
		...
		// Get cached post id.
		$post_id = gambit_get_magazine_post_ids( $this->id, $settings['category'], 1 );

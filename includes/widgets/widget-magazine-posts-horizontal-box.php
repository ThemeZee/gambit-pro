...
class Gambit_Pro_Magazine_Horizontal_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Horizontal Box)', 'gambit-pro' ), // Name.
			array(
				'classname' => 'gambit-magazine-horizontal-box-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a horizontal box. Please use this widget ONLY in the Magazine Homepage widget area.', 'gambit-pro' ),
	...
	function widget( $args, $instance ) {
		...
		if ( ! function_exists( 'gambit_get_magazine_post_ids' ) ) {

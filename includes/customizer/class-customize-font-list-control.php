...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 *
	 */
	class Gambit_Pro_Customize_Font_List_Control extends WP_Customize_Control {
	
		// critical for JS constructor
		public $type = 'gambit_pro_custom_font_list';
		...
		public function __construct($manager, $id, $args = array(), $options = array()) {
			...
			$this->l10n = array(
				'update' =>	__( 'Update Fonts', 'gambit-pro' )
			);
		...
		public function render_content() {
			...
			$default = json_encode( Gambit_Pro_Custom_Font_Lists::get_fonts( 'default' ) );
			$favorite = json_encode( Gambit_Pro_Custom_Font_Lists::get_fonts( 'favorite' ) );
			$popular = json_encode( Gambit_Pro_Custom_Font_Lists::get_fonts( 'popular' ) );
			$all = json_encode( Gambit_Pro_Custom_Font_Lists::get_fonts( 'all' ) );

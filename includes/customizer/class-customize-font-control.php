...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Gambit_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			// Set Fonts.
			$this->fonts = Gambit_Pro_Custom_Fonts::get_available_fonts();
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'gambit-pro-custom-font-control', GAMBIT_PRO_PLUGIN_URL . 'assets/js/custom-font-control.min.js', array( 'customize-controls' ), '20210212', true );
		}

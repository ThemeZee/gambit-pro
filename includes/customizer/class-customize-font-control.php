...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Gambit_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gambit-pro' ),
				'next'     => esc_html__( 'Next Font', 'gambit-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gambit-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = Gambit_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Gambit_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'gambit-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'gambit-pro' ); ?>">
	  							<?php

 ...
 */
 ...
 ( function() {
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		scrollButton.setAttribute( 'aria-label', gambitProScrollToTop.label );
		scrollButton.classList.add( 'scroll-to-top-button' );

		// Add icon to Scroll to Top button.
		var icon = new DOMParser().parseFromString( gambitProScrollToTop.icon, 'text/html' ).body.firstElementChild;

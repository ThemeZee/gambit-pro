=== Gambit Pro ===
Plugin URL: https://themezee.com/addons/gambit-pro/
...
Adds additional features and customization options to the Gambit theme.

== Description ==

The *Gambit Pro* plugin adds additional features to the Gambit theme.
...
1. Install the Gambit Pro Plugin on Plugins -> Add New -> Upload Plugin by uploading the .ZIP plugin file.
...
Please see our [Gambit Theme Documentation](https://themezee.com/docs/gambit-documentation/ "Gambit Theme Documentation").
